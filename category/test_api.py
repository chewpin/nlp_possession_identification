...
file_word_category = open( "stat/word_category.txt", "w")
# file_word_category_1 = open( "stat/word_category_1.txt", "w")
# file_word_category_2 = open( "stat/word_category_2.txt", "w")
# file_word_category_3 = open( "stat/word_category_3.txt", "w")
# file_word_category_4 = open( "stat/word_category_4.txt", "w")
# file_word_category_5 = open( "stat/word_category_5.txt", "w")
# file_word_category_6 = open( "stat/word_category_6.txt", "w")
# file_word_category_7 = open( "stat/word_category_7.txt", "w")
# file_word_category_8 = open( "stat/word_category_8.txt", "w")
# file_word_category_9 = open( "stat/word_category_9.txt", "w")
# file_word_category_10 = open( "stat/word_category_10.txt", "w")
# file_word_category_11 = open( "stat/word_category_11.txt", "w")
# file_word_category_12 = open( "stat/word_category_12.txt", "w")
# file_word_category_13 = open( "stat/word_category_13.txt", "w")
# file_word_category_14 = open( "stat/word_category_14.txt", "w")
# file_word_category_15 = open( "stat/word_category_15.txt", "w")
# file_word_category_16 = open( "stat/word_category_16.txt", "w")
# file_word_category_17 = open( "stat/word_category_17.txt", "w")
# file_word_category_18 = open( "stat/word_category_18.txt", "w")
# file_word_category_19 = open( "stat/word_category_19.txt", "w")
# file_word_category_20 = open( "stat/word_category_20.txt", "w")
# file_word_category_21 = open( "stat/word_category_21.txt", "w")
# file_word_category_22 = open( "stat/word_category_22.txt", "w")
# file_word_category_23 = open( "stat/word_category_23.txt", "w")
# file_word_category_24 = open( "stat/word_category_24.txt", "w")
# file_word_category_25 = open( "stat/word_category_25.txt", "w")
# file_word_category_26 = open( "stat/word_category_26.txt", "w")
# file_word_category_27 = open( "stat/word_category_27.txt", "w")
...
# for round in range(0, 1):
    ...
    category_filename = 'stat/word_category_' + str(filenum_list[round]) + '.txt'
    file_word_category_round = open(category_filename, 'w')
    ...
    for tag in tagged:
        ...
        while True:
            ...
            if temp_indicate == "/object":
                ...
                query_object = str(value_value.replace(" ", ""))
                time.sleep(0.1)
                ...
                try:
                    ...
                    data = json.load(urllib2.urlopen(request, timeout = 10))
                    if data and 'items' in data:
                        objects_temp = data['items'][0]
                        if objects_temp and 'categoryPath' in objects_temp:
                    ...
                    # For Python 2.7
                    print "TIME OUT FOR ", query_object
                file_word_category_round.write( str(value_value) + "\n" + str(top_2_category) + "\n" )
...
for key, value in word_category.iteritems():
    file_word_category.write( str(key) + "\n" + str(value) + "\n" )
...
file_word_category.close()
file_word_category_round.close()
